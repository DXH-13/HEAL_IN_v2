                    ...
                    <div class="container">
                        <div class="tabs-custom row row-50 justify-content-center flex-lg-row-reverse text-center text-md-left"
                            ...
                            <div class="col-lg-4 col-xl-3">
                                <h5 class="text-spacing-200 text-capitalize">Dự án khởi nghiệp</h5>
                                <ul class="nav list-category list-category-down-md-inline-block">
                                    <li class="list-category-item wow fadeInRight" role="presentation"
                                        data-wow-delay="0s"><a class="active" href="#tabs-4-1" data-toggle="tab">Về
                                            Chúng Tôi</a></li>
                                    <li class="list-category-item wow fadeInRight" role="presentation"
                                        data-wow-delay=".1s"><a href="#tabs-4-2" data-toggle="tab">Sứ Mệnh Của Chúng
                                            Tôi</a></li>
                                    <li class="list-category-item wow fadeInRight" role="presentation"
                                        data-wow-delay=".2s"><a href="#tabs-4-3" data-toggle="tab">Mục Tiêu Của Chúng
                                            Tôi</a></li>
                                    <li class="list-category-item wow fadeInRight" role="presentation"
                        ...
                        <div class="row row-60 justify-content-center flex-lg-row-reverse">
                            <div class="col-md-8 col-lg-6 col-xl-5">
                                <div class="offset-left-xl-70">
                                    <h3 class="heading-3">Mọi người nói gì ?</h3>
                                    <div class="slick-quote">
                                        ...
                                        <div class="slick-slider child-carousel" id="child-carousel-5"
                                        ...
                                        <div class="col-md-5 col-xl-6">
                                            <div class="iso-1"><a
                                                    ...
                                                    <img src="assets/images/like-icon-58x25.webp" alt="" width="58"
                                                        height="25" />
                                                </a><span class="iso-1-big">9.4k</span></div>
                                        </div>
                                    </div>
                                </div>

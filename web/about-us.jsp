                                        ...
                                        <ul class="rd-navbar-nav">
                                            ...
                                            <li class="rd-nav-item"><a class="rd-nav-link" href="landing#shop">Shop</a>
                                                <ul class="rd-menu rd-navbar-dropdown">
                                                    <li class="rd-dropdown-item "><a class="rd-dropdown-link" href="single_product?idProduct=1#product">Đoàn Viên</a>
                                                    </li>
                                                    <li class="rd-dropdown-item"><a class="rd-dropdown-link" href="single_product?idProduct=2#product">Tri Kỷ</a>
                                                    </li>
                                                </ul>
                                            </li>
                ...
                <div class="container">
                    <div class="tabs-custom row row-50 justify-content-center flex-lg-row-reverse text-center text-md-left"
                        ...
                        <div class="col-lg-4 col-xl-3">
                            ...
                            </ul><a class="button button-xl button-primary button-winona" href="views/contacts.html">Contact us</a>
                        </div>
                            ...
                            <div class="tab-content tab-content-1">
                                <div class="tab-pane fade show active" id="tabs-4-1">
                                    ...
                                    <p>Sed ut perspiciatis unde omnis iste natus error sit voluptatem accusantium doloremque laudantium,
                                        ...
                                        dolorem ipsum quia dolor sit amet, consectetur.</p><img src="https://placehold.co/832x418" alt=""
                                ...
                                <div class="tab-pane fade" id="tabs-4-2">
                                    ...
                                    <p>Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor incididunt ut labore
                                        ...
                                        aliquip ex ea commodo consequat. Duis aute irure dolor in reprehenderit in voluptate velit esse cillum
                                        dolore eu fugiat nulla pariatur. Excepteur sint occaecat cupidatat non proident, sunt in culpa qui
                                        officia deserunt mollit anim id est laborum.</p><img src="https://placehold.co/832x418" alt=""
                                                                                         width="835" height="418" />
                                </div>
                ...
                <div class="container">
                    ...
                    <div class="row row-lg row-40 justify-content-center">
                        <div class="col-sm-6 col-lg-4 wow fadeInLeft" data-wow-delay=".2s" data-wow-duration="1s">
                            <!-- Team Modern-->
                            <article class="team-modern"><a class="team-modern-figure" href="#"><img src="https://placehold.co/270x236"
                ...
                <div class="container">
                    <div class="row row-60 justify-content-center justify-content-xxl-between">
                        ...
                        <div class="col-md-9 col-lg-6 position-static index-1">
                            <div class="bg-image-right-1 bg-image-right-lg"><img src="https://placehold.co/1110x710" alt="" width="1110"
                                                                                 height="710" />
                                ...
                                <div class="box-transform" style="background-image: url(https://placehold.co/1110x710);"></div>
                            </div>
                        </div>
                    </div>
                </div>
            ...
            <section class="section section-lg bg-default text-md-left">
                <div class="container">
                    <div class="row row-60 justify-content-center flex-lg-row-reverse">
                            ...
                            <div class="offset-left-xl-70">
                                ...
                                <div class="slick-quote">
                                    ...
                                    <div class="slick-slider child-carousel" id="child-carousel-5" data-arrows="true"
                                        ...
                                        <div class="item"><img class="img-circle" src="https://placehold.co/83x83" alt="" width="83"
                                                               height="83" />
                                        </div>
                                        <div class="item"><img class="img-circle" src="https://placehold.co/83x83" alt="" width="83"
                                                               height="83" />
                        ...
                        <div class="col-lg-6 col-xl-7"><img src="https://placehold.co/669x447" alt="" width="669" height="447" />
                        </div>
                    </div>
                </div>
            </section>

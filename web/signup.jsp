<%-- Document : signup Created on : Dec 19, 2024, 9:41:12 AM Author : dangx --%>
                ...
                <div class="row g-0">
                  <div class="col-12 col-md-6">
                    <img class="img-fluid rounded-start w-100 h-100 object-fit-cover" loading="lazy"
                      src="https://placehold.co/592x740" alt="Welcome back you've been missed!">
                  </div>
                      ...
                      <div class="card-body p-3 p-md-4 p-xl-5">
                          ...
                          <div class="col-12">
                            <div class="mb-5">
                              <div class="text-center mb-4">
                                <a href="#!">
                                  <img src="assets/images/Logo web.png" alt="BootstrapBrain Logo" width="175"
                                    height="57">
                                </a>
                              </div>
                        ...
                        <div class="row">
                          <div class="col-12">
                            ...
                            <p class="text-center mt-4" style="margin-bottom:2.7rem ;">Hoặc email</p>
                          </div>
                        </div>
                        <form action="sign_up" method="post">
                          <div class="row gy-3 overflow-hidden">
                            ...
                            <div class="col-12">
                              <div class="form-check">
                                ...
                                <label class="form-check-label text-secondary" for="term">
                                  Tôi chấp nhận <span class="highlight">Điều khoản dịch vụ</span> và <span class="highlight">Chính sách bảo mật</span> của HEAL IN
                                </label>
                            ...
                            <div class="col-12">
                              <div class="d-grid">
                                <button class="btn btnLoginnow btn-lg" type="submit">Đăng ký</button>
                              </div>
                            </div>
                          </div>
                        </form>
                        <div class="row">
                          <div class="col-12">
                            <div class="d-flex justify-content-center mt-3">
                              <a href="log_in" class="link-secondary text-decoration-none">Bạn đã có sẵn tài khoản? Đăng
                                nhập ngay</a>
                            </div>
                          </div>
                        </div>

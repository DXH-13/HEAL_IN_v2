                                ...
                                <div class="col-12 col-md-6 d-flex align-items-center justify-content-center">
                                    <div class="col-12 col-lg-11 col-xl-10">
                                        <div class="card-body p-3 p-md-4 p-xl-5">
                                            ...
                                            <div class="row">
                                                <div class="col-12">
                                                    <div class="d-flex gap-3 flex-column">
                                                        ...
                                                        <a href="https://accounts.google.com/o/oauth2/auth?scope=email profile openid&redirect_uri=http://localhost:9999/HEAL_IN_v2/log_in?loginType=google&response_type=code&client_id=990006517371-6q85h94fvf4baric0cd1r7qtgcci7k5q.apps.googleusercontent.com&approval_prompt=force"
                                            ...
                                            <!-- Updated form with hidden loginType field -->

                ...
                <section class="section section-md bg-default">
                    <div class="container">
                        <h3 class="oh-desktop"><span class="d-inline-block wow slideInDown"
                                style="margin-top: 10px; margin-bottom: 10px;">Nhiệm vụ của chúng tôi</span></h3>
                            ...
                            <div class="row justify-content-end">
                                <div class="col-sm-8 col-md-7 col-lg-5">
                                    <div class="cta-modern">
                                        ...
                                        <p class="lead">Heal In là nơi có trò chơi hay nhất và dịch vụ chất lượng cao.
                                        </p>
                    ...
                    <div class="container">
                        <h3 class="oh-desktop">
                            <span class="d-inline-block wow slideInUp"
                                style="margin-top: 10px; margin-bottom: 10px;">Chọn bộ bài của bạn</span>
                        </h3>
                                ...
                                <div class="col-sm-12 col-lg-4">
                                    <article class="product wow fadeInLeft">
                                        ...
                                        <c:choose>
                                            ...
                                            <c:otherwise>
                                                <span class="product-badge product-badge-sale">Giảm giá</span>
                                            </c:otherwise>
                                        </c:choose>
                                    </article>
                                </div>
                                    ...
                                    <div class="cta-modern">
                                        ...
                                        <p class="cta-modern-text cta-modern-text-2 oh-desktop" data-wow-delay=".1s">
                                            <span
                                                ...
                                                class="d-inline-block wow slideInUp">Có những trải nghiệm tốt nhất với
                                                Heal In!</span>
                    ...
                    <div class="container">
                        <div class="owl-carousel owl-style-11 dots-style-2" data-items="1" data-sm-items="1"
                            ...
                            <article class="box-icon-megan wow fadeInUp">
                                ...
                                <p class="box-icon-megan-text">Dễ dàng mua sắm online với dịch vụ giao hàng nhanh chóng
                                    và đáng tin cậy.
                                </p>
                            </article>
                            <article class="box-icon-megan wow fadeInUp" data-wow-delay=".05s">
                                ...
                                <p class="box-icon-megan-text">Miễn phí giao hàng cho đơn hàng từ 3 board game trở lên.
                                </p>
                            </article>
                            <article class="box-icon-megan wow fadeInUp" data-wow-delay=".1s">
                                ...
                                <p class="box-icon-megan-text">Các board game được chọn lọc kỹ càng để mang đến trải
                                    nghiệm tốt nhất.</p>
                            </article>
                            <article class="box-icon-megan wow fadeInUp" data-wow-delay=".15s">
                                ...
                                <p class="box-icon-megan-text">Cần tư vấn? Đội ngũ thân thiện của chúng tôi luôn sẵn
                                    sàng hỗ trợ!.</p>
                            </article>
                        </div>
                    </div>

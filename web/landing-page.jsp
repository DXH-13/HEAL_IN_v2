<%-- 
    ...
    Created on : Dec 12, 2024, 7:45:56 AM
    Author     : dangx
--%>
...
<html>
    ...
    <body>
        ...
        <div class="page">
                        ...
                        <div class="rd-navbar-inner-outer">
                            <div class="rd-navbar-inner">
                                ...
                                <div class="rd-navbar-panel">
                                    ...
                                    <!-- RD Navbar Brand-->
                                    <div class="rd-navbar-brand"><a class="brand" href="views/home.html"><img class="brand-logo-dark"
                                                                                                              src="assets/images/logo-198x66.png" alt="" width="198" height="66" /></a>
                                    </div>
                                </div>
                                <div class="rd-navbar-right rd-navbar-nav-wrap">
                                    ...
                                    <div class="rd-navbar-main">
                                        ...
                                        <ul class="rd-navbar-nav">
                                            <li class="rd-nav-item active"><a class="rd-nav-link" href="views/home.html">Home</a></li>
                                            <li class="rd-nav-item"><a class="rd-nav-link" href="views/about-us.html">About us</a></li>
                                            <li class="rd-nav-item"><a class="rd-nav-link" href="views/typography.html">Typography</a></li>
                                            <li class="rd-nav-item"><a class="rd-nav-link" href="views/contacts.html">Contacts</a></li>                                              
                                        </ul>
                                    ...
                                    <div class="rd-navbar-project-content rd-navbar-content">
                                        <div>
                                            <div class="row gutters-20" data-lightgallery="group">
                                                <div class="col-6">
                                                    <!-- Thumbnail Creative-->
                                                    <article class="thumbnail thumbnail-creative"><a href="https://placehold.co/1200x800"
                                                                                                     data-lightgallery="item">
                                                            <div class="thumbnail-creative-figure"><img src="https://placehold.co/195x164" alt=""
                        ...
                        <div class="col-sm-6 col-lg-4">
                            <div class="oh-desktop">
                                ...
                                <article class="services-terri wow slideInUp">
                                    <div class="services-terri-figure"><img src="https://placehold.co/370x278" alt="" width="370"
                                                                            height="278" />
                                    </div>
            ...
            <!-- Section CTA-->
            <section class="primary-overlay section parallax-container" data-parallax-img="https://placehold.co/1920x503">
                    ...
                    <div class="row row-lg row-30">
                        <div class="col-sm-6 col-lg-4 col-xl-3">
                            ...
                            <article class="product wow fadeInLeft" data-wow-delay=".15s">
                                <div class="product-figure"><img src="https://placehold.co/161x162" alt="" width="161" height="162" />
                                </div>
            ...
            <!-- Section CTA-->
            <section class="primary-overlay section parallax-container" data-parallax-img="https://placehold.co/1920x558">
                            ...
                            <div class="col-sm-9 col-md-7 col-lg-5">
                                <div class="cta-modern">
                                    ...
                                    <p class="cta-modern-text cta-modern-text-2 oh-desktop" data-wow-delay=".1s"><span
                                        ...
                                        class="button button-lg button-secondary button-winona wow fadeInRight" href="views/contacts.html"
                    ...
                    <div class="owl-carousel owl-style-12" data-items="1" data-sm-items="2" data-lg-items="3" data-margin="30"
                        ...
                        <article class="quote-tara">
                            <div class="quote-tara-caption">
                                ...
                                <div class="quote-tara-figure"><img src="https://placehold.co/115x115" alt="" width="115" height="115" />
                                </div>
                            </div>
                    ...
                    <div class="row row-10 gutters-10 isotope" data-isotope-layout="masonry" data-isotope-group="gallery"
                        ...
                        <div class="col-xs-6 col-sm-4 col-xl-2 isotope-item oh-desktop">
                            ...
                            <article class="thumbnail thumbnail-mary thumbnail-mary-2 wow slideInLeft"><a class="thumbnail-mary-figure"
                                        ...
                                        src="https://placehold.co/310x585" alt="" width="310" height="585" /></a>
                        ...
                        <div class="col-xs-6 col-sm-8 col-xl-4 isotope-item oh-desktop">
                            ...
                            <article class="thumbnail thumbnail-mary thumbnail-mary-big wow slideInRight"><a
                                    ...
                                    data-lightgallery="item"><img src="https://placehold.co/631x587" alt="" width="631" height="587" /></a>
                                <div class="thumbnail-mary-caption">
                                    <div>
                        ...
                        <div class="col-xs-6 col-sm-4 col-xl-2 isotope-item oh-desktop">
                            ...
                            <article class="thumbnail thumbnail-mary thumbnail-mary-2 wow slideInDown"><a class="thumbnail-mary-figure"
                                                                                                          href="https://placehold.co/1200x800" data-lightgallery="item"><img
                                        src="https://placehold.co/311x289" alt="" width="311" height="289" /></a>
                                <div class="thumbnail-mary-caption">
                                    <div>
                            ...
                            <div class="col-sm-6 col-md-7 col-lg-4 col-xl-4">
                                <div class="row row-30 align-items-center text-lg-center">
                                    <div class="col-md-7 col-xl-6"><a class="brand" href="views/home.html"><img
                                                src="assets/images/logo-inverse-198x66.png" alt="" width="198" height="66" /></a></div>
                                    <div class="col-md-5 col-xl-6">
                                        <div class="iso-1"><span><img src="assets/images/like-icon-58x25.png" alt="" width="58"

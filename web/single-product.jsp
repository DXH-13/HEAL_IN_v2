                ...
                <div class="row row-30">
                    <div class="col-lg-6">
                        <div class="slick-vertical slick-product">
                            ...
                            <div class="slick-slider carousel-parent" data-swipe="true" data-items="1"
                                ...
                                <div class="item">
                                    <div class="slick-product-figure"><img src="https://placehold.co/530x480" alt=""
                    ...
                    <div class="col-lg-6">
                        <div class="single-product">
                            <h4 class="text-transform-none text-spacing-50">Margherita Pizza</h4>
                            <div class="group-md group-middle">
                                <div class="single-product-price">$24.00</div>
                            ...
                            <p>Lorem ipsum dolor sit amet, ei impetus epicurei his, ne falli erant consequuntur est. Mei
                                simul aperiam eu, an rebum regione ponderum mel. Facer placerat ut duo, id duis solum
                                maiorum vis, vim autemsemper docendi cu.</p>
                    ...
                    <div class="tab-content">
                        ...
                        <div class="tab-pane fade" id="tabs-3-2">
                            <div class="unit unit-spacing-1 flex-column flex-md-row align-items-lg-center">
                                ...
                                <div class="unit-body">
                                    <p class="text-spacing-50">Lorem ipsum dolor sit amet, consetetur sadipscing elitr,
                                        sed diam nonumy eirmod tempor invidunt ut labore et dolore magna aliquyam erat.
                                        At vero eos et accusam et justo duo dolores et ea rebum. Stet clita kasd
                                        gubergren.On
                                        the other hand, we denounce with righteous indignation and dislike men who are

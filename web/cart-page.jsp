                                            ...
                                            <li class="rd-nav-item ">
                                                ...
                                                <ul class="rd-menu rd-navbar-dropdown">
                                                    <li class="rd-dropdown-item ">
                                                        <a class="rd-dropdown-link" href="single_product?idProduct=1">Đoàn Viên</a>
                                                    </li>
                                                    <li class="rd-dropdown-item">
                                                        <a class="rd-dropdown-link" href="single_product?idProduct=2">Tri Kỷ</a>
                                                    </li>
                                                </ul>
                                            </li>
            ...
            <section id="cart" class="section section-lg bg-default">
                <div class="container">
                    ...
                    <div id="emptyCartMessage" style="display: none; text-align: center;">
                        ...
                        <h3 style="font-size: 20px; margin-bottom: 50px;">Giỏ hàng của bạn còn trống</h3>
                        <a href="landing#shop" class="goShopbtn">Mua ngay</a>
                    </div>
                </div>
